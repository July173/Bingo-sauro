...
try {
    ...
    error_log("Codigo: " . $codigoPartida);
    ...
    if ($codigoPartida) {
        ...
        // Eliminar las bolas asociadas en la tabla historial_llamadas
        $queryEliminarBolas = "DELETE FROM historial_llamadas WHERE id_partida = :id_partida";
        $conexion->delete($queryEliminarBolas, [':id_partida' => $idPartida]);
        ...
        // Respuesta de éxito
        echo json_encode(['success' => true, 'message' => 'Partida eliminada correctamente, junto con los usuarios y bolas.']);
    } else {
